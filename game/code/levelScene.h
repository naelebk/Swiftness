...
namespace swiftness {
    ...
    class levelScene : public gf::Scene {
        public:
            // Constructeur
            levelScene(GameCenter& game, gf::Font& font, int level, std::map<int, swiftness::StaticPlateform>& plateform, swiftness::Square& square, std::vector<Input>& enumVector, gf::Vector2f& camera);
            ...
            void loadLevel(std::map<int, swiftness::StaticPlateform> &plateform, swiftness::Square& square, int level);
